...
async function deliveriesForWorkDate(DB, date, { promoteDraft = true, lookbackDays = 14 } = {}) {
  ...
  return { rows: dedupeDeliveryRows(Array.from(byId.values())), promoted, autoCompleted };
}
...
async function getBootstrap(env, p) {
  ...
  return {
    ...
    deliveries: toFrontendList('deliveries', delPack.rows),
    routes, cartrack,
...
module.exports = {
  ...
  normInvoiceNo, dedupeDeliveryRows, deliveryRowRank,
