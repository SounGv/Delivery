...
const MAPS = {
  ...
  deliveries: [
    ['delivery_id','DeliveryID'],['delivery_date','DeliveryDate'],['customer_name','CustomerName'],
    ['branch_name','BranchName'],['invoice_no','InvoiceNo'],['address','Address'],
    ['latitude','Latitude'],['longitude','Longitude'],['box_qty','BoxQty'],['priority','Priority'],
